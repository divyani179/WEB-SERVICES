 ...
 * 
 */
@WebServiceClient(name = "CalculatorImplService", targetNamespace = "http://test.com/", wsdlLocation = "http://localhost:8085/WS/Calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORIMPLSERVICE_QNAME = new QName("http://test.com/", "CalculatorImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8085/WS/Calculator?wsdl");
    ...
    public CalculatorImpl getCalculatorImplPort() {
        return super.getPort(new QName("http://test.com/", "CalculatorImplPort"), CalculatorImpl.class);
    }
    ...
    public CalculatorImpl getCalculatorImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://test.com/", "CalculatorImplPort"), CalculatorImpl.class, features);
    }
